...
public void doGet(HttpServletRequest req, HttpServletResponse resp)
	...
	if (OfyService.freq == 0){
		return;
	}
	OfyService.count += 5;
	if (OfyService.count < OfyService.freq){
		return;
	}
	...
	try {
		...
		message.setRecipients(Message.RecipientType.TO,
				InternetAddress.parse("ztshining@gmail.com"));
		message.setSubject("Greetings from Connexus");
		message.setText("Dear Mail Crawler," +
				"\n\n This is not spam to my email, please!");
